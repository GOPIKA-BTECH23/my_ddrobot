...
def generate_launch_description():
    ...
    # Convert Xacro to XML string (using Command to dynamically process at runtime)
    ...
    # joint_state_publisher node (optional for joint state publishing)
    ...
    # ros2_control node to load hardware interface and controllers
